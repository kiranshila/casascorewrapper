...
// In some cases we will want to use Julia's nullable types. These types have an
// extra bool. If the definition of Julia's nullable types ever changes, these
...
Direction convertDirection(Direction *input, int newsys,
